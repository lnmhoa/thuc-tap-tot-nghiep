...
$sql_listNews = "SELECT n.id, n.title, n.image, n.content, n.createdAt, n.views, t.name FROM `news` n, `typenews` t WHERE n.typeId = t.id AND n.pin = 0 ORDER BY `createdAt` ASC LIMIT 0, 4";
