<div class="home-container">
    ...
    <!-- Navigation arrows -->
    <button class="hero-nav prev" onclick="changeHeroSlide(-1)">
        <i class="fas fa-chevron-left"></i>
    </button>
    <button class="hero-nav next" onclick="changeHeroSlide(1)">
    ...
    <div class="container">
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p>Công nghệ AI giúp tìm bất động sản phù hợp nhất với nhu cầu của bạn</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">
        ...
        <div class="news-grid">
            ...
            <article class="news-card featured">
                <div class="news-image">
                    <img src="../admin/uploads/news/<?= $pinNewsHome[0]['image'] ?>" alt="<?= htmlspecialchars($pinNewsHome[0]['title']) ?>">
                    <div class="news-badge">Tin nổi bật</div>
                </div>
                <div class="news-content">
                    <div class="news-category"><?= htmlspecialchars($pinNewsHome[0]['name']) ?></div>
                    <h3 class="news-title"><?= htmlspecialchars($pinNewsHome[0]['title']) ?></h3>
                    <p class="news-excerpt"><?= htmlspecialchars(substr($pinNewsHome[0]['content'], 0, 150)) ?>...</p>
                    <div class="news-meta">
                    ...
                    <a href="?act=news&id=<?= $pinNewsHome[0]['id'] ?>" class="read-more">
            ...
            <div class="news-list">
                ...
                <article class="news-item">
                    <div class="news-thumbnail">
                        <img src="../admin/uploads/news/<?= $news['image'] ?>" alt="<?= htmlspecialchars($news['title']) ?>">
                    </div>
                    <div class="news-info">
                        <div class="news-category small"><?= htmlspecialchars($news['name']) ?></div>
                        <h4 class="news-title"><?= htmlspecialchars($news['title']) ?></h4>
                        <p class="news-excerpt"><?= htmlspecialchars(substr($news['content'], 0, 100)) ?>...</p>
                        <div class="news-meta">
                            <span class="news-date">
                                <i class="fas fa-calendar"></i>
