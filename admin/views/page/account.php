                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td data-label="Tên" style="text-align: center;"><img style="width: 80px" src="../logo.jpg" alt="" srcset=""></td>
                            <td data-label="Email"><?= $value["email"] ?></td>
                            <td data-label="Email" style="text-align: center;"><?= $value["phoneNumber"] ?></td>
                            <td data-label="Trạng thái"><span class="status <?= $statusC ?>"><?= $status ?></span></td>
                            <td data-label="Ngày tạo"><?= $value["createdAt"] ?></td>
                            <td data-label="Hành động">
                                <button class="action-button view">Xem</button>
                                <button class="action-button edit">Sửa</button>
                                <button class="action-button lock">Khóa</button>
                            </td>
                        </tr>
                    <?php
                        $stt++;
...
<div id="userModal" class="modal">
    <div class="modal-content">
        ...
        <form id="userForm">
            ...
            <button type="submit" id="saveUserButton">Lưu</button>
...
<div id="deleteConfirmModal" class="modal">
    <div class="modal-content">
        ...
        <h3>Xác Nhận Khóa</h3>
        <p>Bạn có chắc chắn muốn khóa người dùng <strong id="userNameToDelete"></strong> có ID: <strong id="userIdToDelete"></strong> không?</p>
        <div class="modal-actions">
            <button id="confirmDeleteButton" class="action-button lock">Khóa</button>
